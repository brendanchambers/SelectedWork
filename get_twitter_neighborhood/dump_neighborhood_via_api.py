...
json_target_string = 'my friend neighborhood_april20.json' # json save file name
...
# paste temp
    ...
    if current_user.friends_count > MAX_FRIEND_DEGREE:
        vertex['gulper']=True # todo make sure this actually modifies the vertex object
        print "sampling " + str( ((MAX_FRIEND_DEGREE*1.0)/current_user.friends_count)*100) + " % of friends"
    else:
        vertex['gulper']=False
    ...
    if current_user.followers_count > MAX_FOLLOWER_DEGREE:
        ...
        print "sampling " + str( ( (MAX_FOLLOWER_DEGREE*1.0)/current_user.followers_count)*100) + " percent of followers"
    else:
